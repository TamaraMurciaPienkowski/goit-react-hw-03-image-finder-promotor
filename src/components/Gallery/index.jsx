...
class Gallery extends Component {
  ...
  async componentDidUpdate(prevProps, prevState) {
    ...
    if (!isActiveSearchButton) {
      //kiedy isActiveSearchButton === false wtedy opcja zostaje tutaj odpalona poniewaz !isActiveSearchButton = > true
  ...
  render() {
    ...
    return (
      <div
        style={{ padding: '20px', border: '1px solid black', margin: '20px' }}
      >
        <Info
